...
void DataManager::texture_loader(const Texture_& texture_name, const string& path)
{
    Texture tex;
//
...
void DataManager::font_loader(const Font_& font_name,const  string& path)
{
...
Texture& DataManager::get_texture(const Texture_& texture_name)
{   
...
Font& DataManager::get_font(const Font_& font_name)
{
